...
const sendMagicLink = (email, link, message) => __awaiter(void 0, void 0, void 0, function* () {
    return yield new Promise((resolve, reject) => {
        // send mail
        transporter.sendMail({
            to: email,
            subject: "Verify your email address for Arkea",
            // html: `${message} Click <a href = 'https://arkea.up.railway.app/${link}'>here</a> to confirm your email. <br> this link will expire after 1 hours`,
            html: `
            <!DOCTYPE html>
            <html>
            <head>
